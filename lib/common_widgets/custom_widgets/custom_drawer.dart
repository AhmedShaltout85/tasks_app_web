...
class CustomDrawer extends StatefulWidget {
  ...
  const CustomDrawer({super.key, this.selectedIndex = 1, this.onIndexChanged});
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      ...
      DrawerItem(
        ...
        onTap: () => _navigateToScreen(const ManageUserScreen(), 1),
      ),
      DrawerItem(
        index: 2,
        icon: Icons.shield_outlined,
        title: 'عناصر وقائية',
        onTap: () => _navigateToScreen(const PreventiveItemScreen(), 2),
      ),
      DrawerItem(
        index: 3,
        icon: Icons.apps_outage,
        title: 'إدارة التطبيقات',
        onTap: () => _navigateToScreen(const ManageAboutAppScreen(), 3),
      ),
      DrawerItem(
        index: 4,
        icon: Icons.location_on_rounded,
        title: 'إدارة المواقع',
        onTap: () => _navigateToScreen(const ManagePlaceScreen(), 4),
      ),
      DrawerItem(
        index: 5,
        icon: Icons.assessment_rounded,
        title: 'التقارير اليومية',
        onTap: () => _navigateToScreen(const ReportScreen(), 5),
      ),
      DrawerItem(
        index: 6,
        ...
        onTap: () =>
            _navigateToScreen(const PreventiveMaintenanceReportScreen(), 6),
      ),
      DrawerItem(
        index: 7,
        icon: Icons.settings_rounded,
        title: 'الضبط والاعدادات',
        onTap: () => _navigateToScreen(const SettingsScreen(), 7),
      ),
    ];
